 ...
 * BuyPage Component
 * 
 * Main page for browsing and filtering car inventory.
 * Features:
 * - URL parameter support for direct condition filtering
 * - Comprehensive filtering system (price, year, transmission, fuel)
